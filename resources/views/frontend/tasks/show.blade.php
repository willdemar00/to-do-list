                    ...
                    <div class="card card-body mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" value="{{ $task->date ? $task->date->format('Y-m-d') : '' }}" disabled>
                            </div>
                            <div class="col-md-4">
                                <h5 class="form-label">Horário início</h5>
                                <input type="time" class="form-control" value="{{ $task->start_time ? $task->start_time->format('H:i') : '' }}" disabled>
                            </div>
                            <div class="col-md-4">
                                <h5 class="form-label">Horário final</h5>
                                <input type="time" class="form-control" value="{{ $task->end_time ? $task->end_time->format('H:i') : '' }}" disabled>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <img src="{{ $task->user->path_image }}" alt="{{ $task->user->name }}" class="rounded-circle border-primary" width="40" height="40">
                                ...
                                <ul class="list-group">
                                    @foreach($task->involved as $user)
                                        <li class="list-group-item d-flex align-items-center gap-2">
                                            <img src="{{ $user->path_image }}" alt="{{ $user->name }}" class="rounded-circle border-primary" width="40" height="40">
                                            <input type="text" class="form-control m-0" value="{{ $user->name }}" disabled>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
